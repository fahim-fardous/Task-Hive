package com.example.taskhiveapp.presentation.task.list
...
import com.example.taskhiveapp.components.CalendarDataSource
import com.example.taskhiveapp.components.CalendarPreferences
import com.example.taskhiveapp.components.CalendarUiModel
import com.example.taskhiveapp.components.Content
import com.example.taskhiveapp.components.Dialog
import com.example.taskhiveapp.components.Header
import com.example.taskhiveapp.components.NoTaskCard
import com.example.taskhiveapp.components.ProgressType
import com.example.taskhiveapp.components.TaskCard
import com.example.taskhiveapp.components.TaskStatusDialog
...
import com.example.taskhiveapp.utils.HelperFunctions.toLocalDate
    ...
    Scaffold(
        ...
        floatingActionButton = {
            if (projectId != null) {
                FloatingActionButton(
                    onClick = {
                        println("Clicked fab of task list screen")
